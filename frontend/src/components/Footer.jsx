...
const Footer = ({ className = "" }) => {
  return (
    <footer className={`w-full bg-[#FDFBF7] border-t border-stone-200/70 pt-10 sm:pt-12 pb-8 sm:pb-10 ${className}`}>
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-end">
        
        {/* Left Side: Brand Logo */}
        <div className="select-none flex items-center justify-start py-4">
          {/* Giant Wordmark */}
          <div className="font-extrabold text-[38px] min-[360px]:text-[44px] sm:text-[60px] md:text-[80px] tracking-tight text-stone-900 leading-none select-none font-black flex items-center">
            ...
            <div className="flex flex-col justify-between min-h-[140px] gap-4">
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-4 text-stone-500">
                  <a
                    href="https://discord.gg/YwGVj2V5Qk"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Join the VeritasAI Discord community"
                    className="hover:text-stone-900 hover:scale-110 transition-all"
                  >
              ...
              <div className="text-[11px] font-semibold text-stone-400 mt-2">
