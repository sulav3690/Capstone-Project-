          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="flex flex-col gap-3 text-left">
              ...
              <ul className="flex flex-col gap-2.5 text-xs font-medium text-stone-500">
                <li><button onClick={() => setCurrentView('login')} className="hover:text-stone-900 transition-colors text-left cursor-pointer">AI Detector</button></li>
                <li><button onClick={() => setCurrentView('login')} className="hover:text-stone-900 transition-colors text-left cursor-pointer">Misinformation Signals</button></li>
              </ul>
            </div>
            ...
            <div className="flex flex-col gap-3 text-left">
              ...
              <ul className="flex flex-col gap-2.5 text-xs font-medium text-stone-500">
                <li><button onClick={() => setCurrentView('subscription')} className="hover:text-stone-900 transition-colors text-left cursor-pointer">Pricing</button></li>
              </ul>
            </div>

            <div className="flex flex-col gap-3 text-left">
              <h4 className="text-stone-900 font-bold text-sm tracking-wide">Legal</h4>
              <ul className="flex flex-col gap-2.5 text-xs font-medium text-stone-500">
                <li><button onClick={() => setCurrentView('privacy')} className="hover:text-stone-900 transition-colors text-left cursor-pointer">Privacy Policy</button></li>
                <li><button onClick={() => setCurrentView('terms')} className="hover:text-stone-900 transition-colors text-left cursor-pointer">Terms of Use</button></li>
              </ul>
            </div>

            <div className="flex flex-col gap-3 text-left">
              <h4 className="text-stone-900 font-bold text-sm tracking-wide">Support</h4>
              <ul className="flex flex-col gap-2.5 text-xs font-medium text-stone-500">
                <li><button onClick={() => faqRef.current?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-stone-900 transition-colors text-left cursor-pointer">FAQ</button></li>
                <li><button onClick={() => setCurrentView('contact')} className="hover:text-stone-900 transition-colors text-left cursor-pointer">Contact Support</button></li>
              </ul>
            </div>
          </div>
        </div>
