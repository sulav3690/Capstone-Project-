...
import { ShieldCheck, Facebook, Linkedin, Twitter, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#1C1917] flex flex-col font-sans relative overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-6">
          <Link href="/login" className="text-[14px] font-medium text-stone-600 hover:text-stone-900 transition-colors tracking-wide">
            Login
          </Link>
          <Link 
            href="/dashboard" 
            className="bg-[#7B82FF] hover:bg-[#6870fa] text-white text-[14px] font-semibold py-2 px-5 rounded-full shadow-sm hover:shadow transition-all duration-200 hover:-translate-y-[1px] active:translate-y-0"
          >
            Dashboard
          </Link>
        </div>
        ...
        <div className="w-full max-w-[1200px] bg-white border-t border-x border-stone-200/60 rounded-t-[32px] shadow-[0_-15px_40px_rgba(28,25,23,0.03)] relative px-6 sm:px-12 pt-14 pb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2 flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3 mt-1 text-stone-400">
            ...
            <div className="flex flex-col gap-3">
              ...
              <ul className="flex flex-col gap-2 text-[13px] font-medium text-stone-500">
                <li><Link href="/subscription" className="hover:text-stone-900 transition-colors">Pricing</Link></li>
